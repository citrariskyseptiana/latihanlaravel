...
<!-- Content Header (Page header) -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Daftar Mahasiswa</a></li>
              <li class="breadcrumb-item active">Edit Daftar Mahasiswa</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
	...
	<form action="{{ route('biodata.update', ['id' => $data->id]) }}" method="POST" class="form-horizontal">
		...
		<div class="form-group">
			...
			<textarea name="address" rows="10" class="form-control">{{ $data-> name }}</textarea>
		</div>
